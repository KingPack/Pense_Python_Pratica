...
calculo_segundos = (minutos * 60) + segundos

print(f'Segundos: {calculo_segundos}s')
...
calculo_milhas = quilometros * 1.61

print(f'{quilometros} quilometros e igual a {calculo_milhas} milhas')
